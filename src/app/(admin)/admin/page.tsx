    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[
          ...
          { href: '/admin/appraisals', label: 'Appraisals', icon: ClipboardCheck, desc: `Estate appraisals (${Number(appraisalReview.count)} need review)` },
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link href="/admin/consignments" className="text-xs text-muted-foreground hover:text-foreground">
                View all
              </Link>
            </div>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Link href="/admin/appraisals" className="text-xs text-muted-foreground hover:text-foreground">
                View all
              </Link>
            </div>
          </CardHeader>
