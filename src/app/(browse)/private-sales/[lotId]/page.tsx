...
export default async function PrivateSaleDetailPage({
  params,
}: {
  ...
  if (!lot || lot.saleType !== 'private') notFound();
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              <Badge className="bg-charcoal text-white border-0 text-[10px] uppercase tracking-wider font-semibold">
                Private Sale
              </Badge>
              {lot.condition && (
            ...
            <div className="bg-card border border-border/50 rounded-xl p-6 shadow-luxury">
              ...
              <p className="text-sm text-muted-foreground">
                {lot.status === 'sold'
                  ...
                  : 'This work is no longer available for private sale.'}
              </p>
            </div>
          )}
        </div>
