      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-3">Fine Art Antiques Design Fashion Collectibles</p>
          ...
          <div>
            <h4 className="text-[11px] uppercase tracking-wider font-semibold text-white/40 mb-4">Browse</h4>
          ...
          <div>
            <h4 className="text-[11px] uppercase tracking-wider font-semibold text-white/40 mb-4">Selling</h4>
            <ul className="space-y-2.5 text-sm text-white/60">
          ...
          <div>
            <h4 className="text-[11px] uppercase tracking-wider font-semibold text-white/40 mb-4">Legal</h4>
            <ul className="space-y-2.5 text-sm text-white/60">
